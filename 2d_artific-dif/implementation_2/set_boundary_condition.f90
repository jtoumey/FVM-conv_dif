SUBROUTINE SET_BOUNDARY_CONDITION(np,nx,ny,Fx,Fy,dx,dy,ap,an,as,aw,ae,Su,Sp,phiS,phiW,phiN,phiE)
!
IMPLICIT NONE
!
!   Variables passed in
...
real, intent(inout) :: phiS,phiW,phiN,phiE
!
