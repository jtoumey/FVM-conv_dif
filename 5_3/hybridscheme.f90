...
!                follows example 5.3 in Versteeg and Malalasekera, 2nd ed. !
!                The boundary conditions are phi_0 = 1 and phi_L = 0.      !
!                We use the hybrid differencing scheme:                    !
!                   |Pe| >  2      UDS for convective term, diffusion = 0  !
!                   |Pe| <= 2      CDS for convective term, diffusive term !
!                                                                          !
!                Cases                                                     !
!                   (i)   u = 2.5 [m/s], n =  5                            !
!                   (ii)  u = 2.5 [m/s], n = 25                            !
